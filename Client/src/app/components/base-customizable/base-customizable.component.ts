...
import { AfterViewInit, Component, ElementRef, EventEmitter, HostListener, inject, Input, OnChanges, Output, Renderer2 } from '@angular/core';
...
export class BaseCustomizableComponent implements AfterViewInit, OnChanges {
  ...
  // public crdtwsService= inject(NewCRDTWSService<CustomizableModel>);
